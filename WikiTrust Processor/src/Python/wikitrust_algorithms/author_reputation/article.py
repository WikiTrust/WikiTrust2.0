...
class Article:
    ...
    def compute_edit_distance(cls, version_1, version_2) -> float:
        ...
        distance: float = float(max(insertion_total, deletion_total))\
                   - float((0.5*max(insertion_total, deletion_total)))\
                   + float(move_total)
    ...
    def compute_edit_quality(cls, version_1, version_2, version_3) -> float:
        ...
        edit_quality: float = float((cls.compute_edit_distance(version_1, version_3)\
