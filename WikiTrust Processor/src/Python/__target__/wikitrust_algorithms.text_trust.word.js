...
var __name__ = 'wikitrust_algorithms.text_trust.word';
export var Word =  __class__ ('Word', [object], {
	...
	get __str__ () {return __get__ (this, function (self) {
		return __mod__ ('(%s,%.2f)', tuple ([self.text, self.trust]));
	});},
...
//# sourceMappingURL=wikitrust_algorithms.text_trust.word.map