...
var __name__ = 'wikitrust_algorithms.author_reputation.version';
export var Version =  __class__ ('Version', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, author, text) {
		self.author = author;
		self.text = text;
	});},
...
//# sourceMappingURL=wikitrust_algorithms.author_reputation.version.map