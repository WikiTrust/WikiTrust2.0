...
# For revision puller
from wikitrust_py.database.controllers.revision_puller_db_controller import revsion_puller_db_controller
from wikitrust_py.revision_puller.RevisionsWrapper import convert_rev_to_table_row, get_rev_id, tranform_pywikibot_revision_list_into_rev_table_schema_dicts
...
from wikitrust_py.database.controllers.computation_engine_db_controller import computation_engine_db_controller
...
class main_backend_controller:
    ...
    def process_page(
        ...
        )  # TODO: Taking the time here may be problamatic if a revision is added while we're processing the page.
