...
from wikitrust_py_algorithms.text_diff.edit import Edit
from wikitrust_py_algorithms.text_diff.chdiff import edit_diff_greedy, make_index2
...
class Article:
    ...
    def add_new_version(self, new_version) -> None:
        ...
        for reference_version_iter in reference_version_range:
            ...
            if Author.check_same_author(
                judged_version.author, new_version.author
            ):
    ...
    def compute_edit_distance(cls, version_1, version_2) -> float:
        ...
        edit_index: Dict[Tuple[str, str],
                         List[int]] = make_index2(split_version_2)
        edit_list_tuples: List[Tuple[int, int, int, int]] = edit_diff_greedy(
            split_version_1, split_version_2, edit_index
        )
