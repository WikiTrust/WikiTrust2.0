import wikitrust.storage_engine.storage_engine as StorageEngine
...
def test_storage_engine():
    ...
    se.store(page_id=3, version_id="100", rev_id=randomInteger, text="asdf", timestamp=datetime.now(), kind="stuff")
