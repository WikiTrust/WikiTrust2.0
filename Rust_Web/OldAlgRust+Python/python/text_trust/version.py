...
class Version:
    ...
    def __init__(self, word_list, edit_list, author_rep,constants):
        """
        Version Constructor:
    ...
    @classmethod
    def create_initial_version(cls, text_list, initial_trust, constants):
        """
        ...
        word_list = Word.create_list_words(text_list,\
    ...
    @classmethod
    def create_next_version(cls, prev_version: "Version", new_text, \
        new_edits, author_rep) -> "Version":
        """
        ...
        prev_word_list = prev_version.word_list
        ...
        #is finished)
        new_word_list = Word.create_list_words(new_text, \
        ...
        for edit in new_edits:
            ...
            if edit.edit_type == Edit.MOVE:
                ...
                #scaled by word_iter
                for word_iter in range(edit.lengthr):
    ...
    def compute_blocks(self):
        ...
        present_edits = [edit for edit in self.edit_list if edit.destination >= 0]
        ...
        for edit in present_edits:
            ...
            end_words: int = start_words + edit.lengthr
        ...
        for block in self.block_list:
            ...
            if block.edit.edit_type == Edit.MOVE:
                ...
                if (block.edit.origin == block.edit.destination) and \
                   (block.edit.destination == len(self.word_list)-block.edit.lengthr):
        ...
        for block in self.block_list:
            ...
            if block.left_bound_change:
                for word_iter, word in enumerate(block.words):
                    ...
                    new_word_trust_left = word.trust + \
            ...
            if block.right_bound_change:
                for word_iter, word in enumerate(block.words):
                    ...
                    #Compute new trust for Word
                    new_word_trust_right = word.trust + \
                    ((self.trust_inheritance_const * self.author_rep - word.trust) * \
